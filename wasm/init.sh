...
token)
    ...
    cleos --url http://127.0.0.1:51043 --wallet-url http://127.0.0.1:6666 set contract useraaaaaaaj /home/eos/eosio.contracts/build/eosio.token/ eosio.token.wasm eosio.token.abi
...
mallard)
    ...
    cleos --url http://127.0.0.1:51043 --wallet-url http://127.0.0.1:6666 push action useraaaaaaaj issue '["gamemallards","1.0000 TES","xxx"]' -p useraaaaaaai
    ...
    cleos --url http://127.0.0.1:51043 --wallet-url http://127.0.0.1:6666 set contract gamemallards ./ mallard.wasm mallard.abi
    # init symbol
    cleos --url http://127.0.0.1:51043 --wallet-url http://127.0.0.1:6666 get currency balance useraaaaaaaj gamemallards "TES"
...
lizard)
    ...
    cleos --url http://127.0.0.1:51043 --wallet-url http://127.0.0.1:6666 push action useraaaaaaaj issue '["game12lizard","1.0000 TES","xxx"]' -p useraaaaaaai
